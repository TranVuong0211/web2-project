...
<link rel="stylesheet" type="text/css" href="testlogin.php"/>
						...
						<div class="item">
						   <div class="item-wrap">
							  <div class="item-image">
									 <a class="product-image no-touch" href="#" title="Wacom Intuous CTL-4100e">
									 <img class="first_image" src="images/position-10/wacom.jpg" alt="Product demo" /> 
									 </a>
									 <div class="item-btn">
										<div class="box-inner">
										   <a title="Add to wishlist" href="#" class="link-wishlist">&nbsp;</a>
								  ...
								  <div class="pro-info">
									 <div class="pro-inner">
										<div class="pro-title product-name"><a href="detail.html">Wacom Intuous CTL-4100</a></div>
										<div class="pro-content">
										   <div class="wrap-price">
											  <div class="price-box">
												 <span class="regular-price">
						   ...
						   <div class="item-wrap">
							  <div class="item-image">
									 <a class="product-image no-touch" href="#" title="XP-Pen Deco 02">
									 <img class="first_image" src="images/position-10/xppen.jpg" alt="Product demo" /> 
									 </a>
									 <div class="item-btn">
										<div class="box-inner">
										   <a title="Add to wishlist" href="#" class="link-wishlist">&nbsp;</a>
								  ...
								  <div class="pro-info">
									 <div class="pro-inner">
										<div class="pro-title product-name"><a href="detail.html">XP-Pen Deco 02</a></div>
										<div class="pro-content">
										   <div class="wrap-price">
											  <div class="price-box">
												 <span class="regular-price">
						   ...
						   <div class="item-wrap">
							  <div class="item-image">
									 ...
									 <img class="first_image" src="images/position-10/xppro.jpg" alt="Product demo" /> 
									 </a>
									 <div class="item-btn">
										<div class="box-inner">
										   <a title="Add to wishlist" href="#" class="link-wishlist">&nbsp;</a>
									 ...
									 <div class="pro-inner">
										...
										<div class="pro-content">
										   <div class="wrap-price">
											  <div class="price-box">
												 <span class="regular-price">
												 <span class="price">$9.060.000</span></span>
												 <p class="special-price">
													<span class="price">$9.260.000</span>
												</p>
											  </div>
										   </div>
										   <!-- div class="ratings">
						   ...
						   <div class="item-wrap">
							  <div class="item-image">
									 <a class="product-image no-touch" href="#" title="Bảng hắt sáng">
						   ...
						   <div class="item-wrap">
							  <div class="item-image">
									 <a class="product-image no-touch" href="#" title="XP-pen Deco Mini 7">
									 <img class="first_image" src="images/position-10/xppenmini.jpg" alt="Product demo" /> 
									 </a>
									 <div class="item-btn">
										<div class="box-inner">
										   <a title="Add to wishlist" href="#" class="link-wishlist">&nbsp;</a>
								  ...
								  <div class="pro-info">
									 <div class="pro-inner">
										<div class="pro-title product-name"><a href="detail.html">XP-pen Deco Mini 7</a></div>
										<div class="pro-content">
										   <div class="wrap-price">
											  <div class="price-box">
												 <span class="regular-price">
